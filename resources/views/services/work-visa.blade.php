							...
							<div class="col">
								<nav aria-label="breadcrumb">
								  	<ol class="breadcrumb white-color">
								    	...
								    	<li class="breadcrumb-item active" aria-current="page">Work Visa</li>
								  	</ol>
								</nav>
							</div>
						</div>  <!-- End row -->
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="about-9-txt mb-40 pr-15">
									...
									<!-- Title -->
									<h3 style="color:Tomato;" class="h3-md">Work visa</h3>
									{!!$check->description!!}
									
						
								
									<p>A general overview of the Employer Sponsored visas: -
									</p>
						...
						<div class="row">
							<div class="col-md-12">
								<div >
								    ...
								    <img src="images/workvisatbl.png" width=100% height=100% alt="mobile-logo"/>
								</div>
							</div>
						</div>
					</div>
...
<p></p>
 ...
 <h5 style="color:tomato;" class="h3-md">Please Note: -</h5>
                                    
									<p>The above requirements are an overview of the Employer Sponsored Visas. The visa process for these visas can be complex take the guess work out and please <a style="color:red;" href="contact-us.html">book a free initial consultation</a>  with one of our consultants so we can explain the requirements in more detail and determine your eligibility. 
									</p>
