							...
							<div class="col">
								<nav aria-label="breadcrumb">
								  	<ol class="breadcrumb white-color">
								    	...
								    	<li class="breadcrumb-item active" aria-current="page">Student Visa</li>
								  	</ol>
								</nav>
							</div>
						</div>  <!-- End row -->
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="about-9-txt mb-40 pr-15">
									...
									<!-- Title -->
									<h3 class="h3-md">Resident visa</h3>
								{!!$check->description!!}
...
<p></p>
			...
			<div class="row">	
							<div class="col-md-12 section-title center">		
				 				...
				 				<!-- Title -->
				 				<h4 style="color:Tomato;">Book your free initial consultation </h4>
								<h5 class="h2-xs">with us for a student visa application so we can help you pursue to education dreams in Australia.</h5>
								<P></P>
